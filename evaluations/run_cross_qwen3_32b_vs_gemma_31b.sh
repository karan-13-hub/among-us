#!/usr/bin/env bash
# Run eval_cross_qwen3_32b_vs_gemma_31b.ipynb via papermill.
#
# Usage:
#   ./run_cross_qwen3_32b_vs_gemma_31b.sh              # foreground
#   nohup ./run_cross_qwen3_32b_vs_gemma_31b.sh &      # background
#
# Override env vars to customise paths:
#   CONDA_BASE   conda installation root
#   CONDA_ENV    conda env name (default: verl-gemma)
#   EVAL_BASE    output root (default: /home/yjangir1/scratchhbharad2/users/yjangir1/karan/eval-cross-play-among-us-qwen3-32b-vs-gemma-31b)
#   SECRETS_ENV  optional env-file with OPENAI_API_KEY etc.
set -euo pipefail

_SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
NOTEBOOK="${_SCRIPT_DIR}/eval_cross_qwen3_32b_vs_gemma_31b.ipynb"
...
EVAL_BASE="${EVAL_BASE:-/home/yjangir1/scratchhbharad2/users/yjangir1/karan/eval-cross-play-among-us-qwen3-32b-vs-gemma-31b}"
